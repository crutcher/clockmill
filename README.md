...
I added `burn`s implementation of `Tensor::unfold()` to enable and demonstrate
that vectorized window tensor operations are an efficient pathway to high-performance
spatial simulation.
